...
def _apply_thinking_capture_patches(
    ...
    Applies 4 patches that intercept reasoning content at different points in
    aider's processing pipeline. Also patches clone() so lint_coder clones
    inherit the patches. Behaviour matches agents_go.py.
    """
